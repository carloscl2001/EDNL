...
template <typename tCoste>
tCoste Grecoland_version_mejorada(const vector<ciudad> Fobos, const vector<ciudad> Deimos, const vector<vertice> costerasFobos, 
                const vector<vertice> costerasDeimos, vertice origen, vertice destino){
    typedef typename GrafoP<tCoste>::vertice vertice;
    static const double INF;
    ...
    gFinal = Kruskal(sGrafo);

    vector<vertice> V;
    vector<tCoste> vDjikstra;

    vDjikstra = Dijkstra(gFinal, origen, V);
